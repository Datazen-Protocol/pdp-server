...
replace github.com/storacha/piri => ../
...
require (
	...
	github.com/storacha/go-libstoracha v0.1.1-0.20250619162540-1e6082bcad68 // indirect
	github.com/storacha/go-ucanto v0.4.2-0.20250619152010-a37ab7e132b3 // indirect
